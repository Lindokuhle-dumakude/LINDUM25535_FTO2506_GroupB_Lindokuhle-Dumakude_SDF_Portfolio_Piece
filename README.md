...
This is a **responsive personal resume website** built using **HTML5** and **Tailwind CSS**. It serves as a digital portfolio highlighting my professional profile, skills, and experience in a clean and visually engaging layout.

---

## ✨ Key Features

- ✅ **Hero Section**: Includes a profile image, name, and a short professional title and description.
- ✅ **Responsive Design**: Mobile-friendly layout using Tailwind's responsive utility classes.
- ✅ **Skills Section**: Skill bars created with Tailwind CSS to visually represent proficiency.
- ✅ **Modern Styling**: Custom colors, rounded corners, spacing, and font sizes implemented via Tailwind for a good UI.
- ✅ **Custom Fonts**: Google Fonts imported to enhance readability and design.
...
- **Icons8** * – For heart and tool icons
...
- Creating responsive layouts using Tailwind utility classes  
- Building skill bars using `div` elements and Tailwind width utilities  
- Using `flex`, `gap`, `rounded`, `text-*`, and custom color classes effectively  
- Embedding custom fonts from Google Fonts  
- Managing spacing and alignment for clean UI  

---

## Video Presentation link

- https://www.loom.com/share/48d40e140e2a46f6bd36242a6e354001?sid=156934f1-0611-4812-8291-6c24d6b11204

- https://www.loom.com/share/02fcaeb953fc4b19b3629712a9f6938a?sid=c895ee5a-4ff9-4d47-abea-4f0a8d6cff0a